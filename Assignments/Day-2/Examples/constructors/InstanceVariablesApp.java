...
{
	private int rollno;
	private String name;  // object level variables
	long phoneNumber;
	String emaild;
	Date dob;
	int count;
...
public class InstanceVariablesApp {
	...
	public static void main(String[] iiiiii) {
		// TODO Auto-generated method stub
		// classname objectname = new classname();
Student s1=new Student(123,"Mar"); // automaticaly all variabls gets iniatialized
//s1.rollno=567;
